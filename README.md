[![Stars](https://img.shields.io/github/stars/RanaAhmar/distributed-systems-case-studies?style=for-the-badge)](https://github.com/RanaAhmar/distributed-systems-case-studies/stargazers) [![Issues](https://img.shields.io/github/issues/RanaAhmar/distributed-systems-case-studies?style=for-the-badge)](https://github.com/RanaAhmar/distributed-systems-case-studies/issues) [![MIT License](https://img.shields.io/badge/License-MIT-green.svg?style=for-the-badge)](https://github.com/RanaAhmar/distributed-systems-case-studies/blob/main/LICENSE)

# 🏗️ Distributed Systems Case Studies

Learn from the giants. Architectural breakdowns of high-scale systems. Curated by **Ahmar Hussain** (**Stackaura**).

## 📚 Cases
- Netflix: Microservices & Chaos Engineering.
- Uber: Ringpop & Geospatial indexing.
